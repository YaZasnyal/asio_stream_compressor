...
public:
  ...
  void start()
  {
    socket_.async_read_some(asio_stream_compressor::asio::buffer(data_, max_length),
      ...
      size_t bytes_transferred)
  {
    if (!error)
    {
      asio_stream_compressor::asio::async_write(socket_,
...
public:
      ...
      acceptor_(io_context_, tcp::endpoint(tcp::v4(), port))
  {
    ...
    acceptor_.async_accept(new_session->socket(),
        std::bind(&echo_server::handle_accept, this, new_session,
          std::placeholders::_1));
  }
