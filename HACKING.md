...
hidden if the `asio_stream_compressor_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `asio_stream_compressor_DEVELOPER_MODE` to the configure
